...
import { BarChart3, Bell, FileText, Home, LogOut, Menu, Moon, Settings, Sun, User, X } from "lucide-react"
...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Contributions", href: "/dashboard/contributions", icon: BarChart3 },
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r">
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            <div className="flex flex-shrink-0 items-center px-4">
              <Link href="/dashboard" className="flex items-center">
                <span className="text-xl font-bold">Pension Management System</span>
              </Link>
            </div>
